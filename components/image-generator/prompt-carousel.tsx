...
import { PromptSuggestion } from "@/lib/types/image-ai";
      ...
      <Card className="bg-[#1A1D23] border-indigo-500/30">
        <CardContent className="p-6">
          <div className="text-center">
            <Sparkles
              size={32}
              className="text-indigo-400 animate-pulse mx-auto mb-4"
            />
      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-medium">Prompt Suggestions</span>
